...
<style>
  /* ========================================
   ANALYTICS DASHBOARD - PREMIUM DESIGN v2.0
   Enhanced Component Backgrounds & Visual Depth
   ======================================== */
...
:root {
  ...
  /* Enhanced KPI Specific Colors */
  --color-revenue: #10b981;
  --color-revenue-bg: #ecfdf5;
  --color-revenue-border: #6ee7b7;
  --color-customers: #3b82f6;
  --color-customers-bg: #eff6ff;
  --color-customers-border: #93c5fd;
  --color-retention: #8b5cf6;
  --color-retention-bg: #f5f3ff;
  --color-retention-border: #c4b5fd;
  --color-risk: #ef4444;
...
.page-header::after {
  ...
  width: 400px;
  height: 400px;
  background: radial-gradient(circle, rgba(5, 223, 215, 0.2) 0%, transparent 70%);
  border-radius: 50%;
  pointer-events: none;
}
...
.page-header h1 i {
  font-size: 2rem;
  opacity: 0.9;
  filter: drop-shadow(0 2px 8px rgba(5, 223, 215, 0.3));
}
...
/* KPI Card Variants - Enhanced Backgrounds */
.kpi-card.revenue {
  background: linear-gradient(135deg, var(--color-revenue-bg) 0%, #ffffff 100%);
  border-color: var(--color-revenue-border);
}
...
.kpi-card.revenue::after {
  background: linear-gradient(90deg, transparent, var(--color-revenue), transparent);
}

.kpi-card.customers {
  background: linear-gradient(135deg, var(--color-customers-bg) 0%, #ffffff 100%);
...
.kpi-card.customers::after {
  background: linear-gradient(90deg, transparent, var(--color-customers), transparent);
}

.kpi-card.retention {
  background: linear-gradient(135deg, var(--color-retention-bg) 0%, #ffffff 100%);
  border-color: var(--color-retention-border);
}
...
.kpi-card.retention::after {
  background: linear-gradient(90deg, transparent, var(--color-retention), transparent);
}

.kpi-card.risk {
  background: linear-gradient(135deg, var(--color-risk-bg) 0%, #ffffff 100%);
...
.chart-header h3 i.fa-chart-line {
...
.chart-header .tooltip[title]:hover::after {
  content: attr(title);
  position: absolute;
  top: 100%;
  left: 0;
...
.chart-stats .stat-change.positive {
  color: var(--color-success);
}

.chart-stats .stat-change.negative {
...
@media (prefers-color-scheme: dark) {
  ...
  .kpi-card,
  .chart-card {
    box-shadow: 0 8px 16px -2px rgba(0, 0, 0, 0.4), 0 4px 8px -4px rgba(0, 0, 0, 0.3);
  }
  ...
  .kpi-card.retention {
    background: linear-gradient(135deg, rgba(139, 92, 246, 0.15) 0%, #1e293b 100%);
  }
  ...
  .chart-stats {
    background: linear-gradient(135deg, 
      ...
      rgba(8, 131, 149, 0.1) 50%,
      rgba(5, 223, 215, 0.1) 100%
    );
  }
}
...
/* === ENHANCED COMPONENT BACKGROUNDS === */
/* Add subtle patterns to cards for depth */
.kpi-card.revenue,
.kpi-card.customers,
.kpi-card.retention,
.kpi-card.risk {
  background-size: 200% 200%;
  transition: background-position 0.5s ease, transform var(--transition-base), box-shadow var(--transition-base);
}
...
/* Enhanced chart card background with subtle pattern */
.chart-card {
  background-image: 
    ...
    repeating-linear-gradient(
      ...
      transparent,
      transparent 10px,
      rgba(10, 77, 104, 0.01) 10px,
      rgba(10, 77, 104, 0.01) 20px
    );
...
.chart-card:hover .chart-stats .stat-value {
  color: var(--color-primary);
}

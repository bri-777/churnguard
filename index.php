...
<div class="data-card" style="opacity:0; pointer-events:auto; height:0; overflow:hidden;">
  <div class="card-header">
  ...
  <div class="card-body">
    <div class="form-grid">
      <div class="form-group">
        <label for="morningReceiptCount">Morning Receipt Count *</label>
        <input type="number" id="morningReceiptCount" min="0" required>
      </div>

      <div class="form-group">
        <label for="morningSalesVolume">Morning Sales Volume *</label>
        <input type="number" id="morningSalesVolume" min="0" step="0.01" required>
      </div>

      <div class="form-group">
        <label for="swingReceiptCount">Midday Receipt Count *</label>
        <input type="number" id="swingReceiptCount" min="0" required>
      </div>

      <div class="form-group">
        <label for="swingSalesVolume">Midday Sales Volume *</label>
        <input type="number" id="swingSalesVolume" min="0" step="0.01" required>
      </div>

      <div class="form-group">
        <label for="graveyardReceiptCount">Evening Receipt Count *</label>
        <input type="number" id="graveyardReceiptCount" min="0" required>
      </div>

      <div class="form-group">
        <label for="graveyardSalesVolume">Evening Sales Volume *</label>
        <input type="number" id="graveyardSalesVolume" min="0" step="0.01" required>
      </div>

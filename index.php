  ...
  <div class="analytics-container">
    <header class="dashboard-header">
      ...
      <h1 class="main-title">
        ...
        <span class="title-pulse">Intelligence Hub</span>
      </h1>
      <p class="subtitle">Real-time insights for exceptional business intelligence</p>
      <div class="stats-bar">
        <div class="stat-item">
...
.page {
  ...
  background: linear-gradient(135deg, #0a1929 0%, #001e3c 50%, #0a2540 100%);
  min-height: 100vh;
  padding: 2.5rem;
  color: #e3f2fd;
  position: relative;
...
.page::before {
  ...
  bottom: 0;
  background-image:
    radial-gradient(circle at 20% 30%, rgba(5, 223, 215, 0.08) 0%, transparent 50%),
    radial-gradient(circle at 80% 70%, rgba(8, 131, 149, 0.06) 0%, transparent 50%);
  pointer-events: none;
}
...
.dashboard-header {
  ...
  border-bottom: 1px solid rgba(5, 223, 215, 0.15);
  position: relative;
}
...
.header-glow {
  ...
  width: 600px;
  height: 200px;
  background: radial-gradient(ellipse, rgba(5, 223, 215, 0.15), transparent 70%);
  filter: blur(40px);
  pointer-events: none;
}
...
.header-badge {
  ...
  gap: 0.5rem;
  padding: 0.5rem 1rem;
  background: rgba(5, 223, 215, 0.1);
  border: 1px solid rgba(5, 223, 215, 0.3);
  border-radius: 20px;
  color: #05dfd7;
  font-size: 0.875rem;
  font-weight: 600;
...
.title-gradient {
  background: linear-gradient(135deg, #05dfd7 0%, #0af5e3 50%, #05dfd7 100%);
...
.card-shimmer {
  ...
  width: 100%;
  height: 100%;
  background: linear-gradient(90deg, transparent, rgba(5, 223, 215, 0.1), transparent);
...
.card-glow-loyalty { background: rgba(5, 223, 215, 0.2); top: -50px; right: -50px; }
.card-glow-behavior { background: rgba(8, 131, 149, 0.2); top: -50px; left: -50px; }
.card-glow-segment { background: rgba(10, 77, 104, 0.3); bottom: -50px; right: -50px; }
.card-glow-engagement { background: rgba(5, 223, 215, 0.2); top: 50%; left: 50%; transform: translate(-50%, -50%); }
.card-glow-performance { background: rgba(16, 185, 129, 0.2); top: -50px; right: -50px; }
.card-glow-traffic { background: rgba(59, 130, 246, 0.2); bottom: -50px; left: -50px; }
.card-glow-predictive { background: rgba(168, 85, 247, 0.2); top: 50%; right: -50px; }
.card-glow-report { background: rgba(5, 223, 215, 0.15); top: -50px; left: 50%; transform: translateX(-50%); }

.metric-card:hover {
  transform: translateY(-8px);
  border-color: rgba(5, 223, 215, 0.3);
  box-shadow: 0 20px 60px rgba(5, 223, 215, 0.15);
}
...
.card-icon {
  width: 56px;
  height: 56px;
  background: linear-gradient(135deg, rgba(5, 223, 215, 0.2), rgba(8, 131, 149, 0.3));
  border: 1px solid rgba(5, 223, 215, 0.3);
  border-radius: 14px;
  display: flex;
  align-items: center;
...
.metric-card:hover .card-icon {
  ...
  box-shadow: 0 8px 24px rgba(5, 223, 215, 0.3);
}
...
.status-info {
  background: rgba(5, 223, 215, 0.15);
  color: #05dfd7;
  border: 1px solid rgba(5, 223, 215, 0.3);
}
...
.featured-stat {
  background: linear-gradient(135deg, rgba(5, 223, 215, 0.1), rgba(8, 131, 149, 0.15));
  border: 1px solid rgba(5, 223, 215, 0.25);
  border-radius: 14px;
  padding: 1.5rem;
  margin-bottom: 1.5rem;
  text-align: center;
...
.insight-icon {
  width: 40px;
  height: 40px;
  background: linear-gradient(135deg, rgba(5, 223, 215, 0.2), rgba(8, 131, 149, 0.15));
  border-radius: 10px;
  display: flex;
  align-items: center;
  justify-content: center;
...
.tier-regular .tier-dot { background: #64b5f6; }
.tier-loyal .tier-dot { background: #05dfd7; }
.tier-vip .tier-dot { background: #ffd700; }
...
.rank-3 { background: linear-gradient(135deg, #cd7f32, #e5a564); color: #1a1a1a; }
...
.product-bar-fill {
  height: 100%;
  background: linear-gradient(90deg, #05dfd7, #0af5e3);
  border-radius: 4px;
...
.heat-low { background: rgba(5, 223, 215, 0.2); }
.heat-medium { background: rgba(5, 223, 215, 0.5); }
.heat-high { background: rgba(5, 223, 215, 0.8); }

.heatmap-cell:hover {
  transform: scale(1.15);
  box-shadow: 0 4px 12px rgba(5, 223, 215, 0.4);
}
...
.segment-fill {
  height: 100%;
  background: linear-gradient(90deg, #088395, #05dfd7);
  border-radius: 12px;
  transition: width 1s ease;
}
...
.weekday-bar {
  width: 100%;
  background: linear-gradient(180deg, #05dfd7, #088395);
  border-radius: 6px 6px 2px 2px;
  transition: all 0.3s ease;
}

.weekday-item:hover .weekday-bar {
...
.kpi-primary {
  background: rgba(5, 223, 215, 0.08);
  border-color: rgba(5, 223, 215, 0.2);
}
...
.kpi-card:hover {
  transform: translateY(-4px);
  box-shadow: 0 12px 32px rgba(5, 223, 215, 0.15);
}
...
.mini-bar:hover {
  ...
  background: linear-gradient(180deg, #0af5e3, #05dfd7);
}
...
.report-column-header {
  ...
  margin-bottom: 1.5rem;
  padding-bottom: 1rem;
  border-bottom: 1px solid rgba(5, 223, 215, 0.2);
  color: #05dfd7;
}
...
.export-btn {
  ...
  gap: 0.75rem;
  padding: 1rem;
  background: linear-gradient(135deg, rgba(5, 223, 215, 0.15), rgba(8, 131, 149, 0.1));
  border: 1px solid rgba(5, 223, 215, 0.3);
  border-radius: 12px;
  color: #05dfd7;
  font-size: 0.9375rem;
...
.export-btn:hover {
  background: linear-gradient(135deg, rgba(5, 223, 215, 0.25), rgba(8, 131, 149, 0.15));
  transform: translateY(-2px);
  box-shadow: 0 8px 24px rgba(5, 223, 215, 0.2);
}

.export-pdf { border-color: rgba(239, 68, 68, 0.3); color: #ef4444; }
.export-pdf:hover { background: linear-gradient(135deg, rgba(239, 68, 68, 0.15), rgba(239, 68, 68, 0.05)); }

.export-excel { border-color: rgba(34, 197, 94, 0.3); color: #22c55e; }
.export-excel:hover { background: linear-gradient(135deg, rgba(34, 197, 94, 0.15), rgba(34, 197, 94, 0.05)); }

.export-csv { border-color: rgba(59, 130, 246, 0.3); color: #3b82f6; }
.export-csv:hover { background: linear-gradient(135deg, rgba(59, 130, 246, 0.15), rgba(59, 130, 246, 0.05)); }

.export-share { border-color: rgba(168, 85, 247, 0.3); color: #a855f7; }
.export-share:hover { background: linear-gradient(135deg, rgba(168, 85, 247, 0.15), rgba(168, 85, 247, 0.05)); }
...
.dashboard-footer {
  margin-top: 3rem;
  padding: 2rem 0;
  border-top: 1px solid rgba(5, 223, 215, 0.15);
}
...
.footer-btn:hover {
  background: linear-gradient(135deg, rgba(5, 223, 215, 0.25), rgba(8, 131, 149, 0.15));
  transform: translateY(-2px);
  box-shadow: 0 6px 20px rgba(5, 223, 215, 0.2);
}
